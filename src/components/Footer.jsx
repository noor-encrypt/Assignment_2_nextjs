        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-10">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-3 text-base text-gray-700">
              ...
              <li><Link href="/services" className="hover:text-[#FF385C] transition-colors">Services</Link></li>
              <li><Link href="/contact" className="hover:text-[#FF385C] transition-colors">Contact</Link></li>
            </ul>
          </div>
