      ...
      <main className="flex-grow flex flex-col items-center mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-11/12 max-w-6xl">
          ...
          <div className="bg-white rounded-3xl shadow-md p-8 text-center border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition">
            ...
            <Link href="/" className="bg-[#FF385C] text-white px-5 py-2 rounded-full hover:bg-[#e0314f] transition">
              Visit
            </Link>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-md p-8 text-center border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition">
            ...
            <Link href="/services" className="bg-[#FF385C] text-white px-5 py-2 rounded-full hover:bg-[#e0314f] transition">
              View
            </Link>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-md p-8 text-center border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition">
            ...
            <Link href="/about" className="bg-[#FF385C] text-white px-5 py-2 rounded-full hover:bg-[#e0314f] transition">
              Learn
            </Link>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-md p-8 text-center border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition">
            ...
            <Link href="/contact" className="bg-[#FF385C] text-white px-5 py-2 rounded-full hover:bg-[#e0314f] transition">
              Contact
            </Link>
          </div>
